#ifndef POL_QSHOW_MAT_256L_M2_H
#define POL_QSHOW_MAT_256L_M2_H

#include "arith_qshow.h"

typedef struct {
    poly_qshow_vec_m2 rows[PARAM_ARP_DIV_N_L_SHOW];
} __poly_qshow_mat_256l_m2;

typedef __poly_qshow_mat_256l_m2 poly_qshow_mat_256l_m2[1];
