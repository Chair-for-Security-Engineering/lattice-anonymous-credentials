...
/*************************************************
* Name:        poly_qiss_vec_256_l_setup
*
* Description: Initialize and setup the backend for arithmetic 
*              mod PARAM_Q_ISS integer vectors with PARAM_ARP_DIV_N_L_ISS entries. 
...
/*************************************************
* Name:        poly_qiss_vec_256_l_teardown
*
...
/*************************************************
* Name:        poly_qiss_vec_256_l_init
*
* Description: Initialize polynomial vector with PARAM_ARP_DIV_N_L_ISS entries.
*              This is strictly required before any operations 
*              are done with/on the vector.
* 
* Arguments:   - poly_qiss_vec_256_l arg: polynomial vector to be initialized
**************************************************/
...
/*************************************************
* Name:        poly_qiss_vec_256_l_clear
*
* Description: Clear polynomial vector with PARAM_ARP_DIV_N_L_ISS entries.
*              This is strictly required to avoid memory leaks and the 
*              polynomial vector must not be used again (unless reinitialized).
* 
* Arguments:   - poly_qiss_vec_256_l arg: polynomial vector to be cleared
**************************************************/
...
/*************************************************
* Name:        poly_qiss_vec_256_l_zero
*
* Description: Set an initialized polynomial vector with PARAM_ARP_DIV_N_L_ISS entries to zero
* 
* Arguments:   - poly_qiss_vec_256_l arg: polynomial vector to be zeroized (initialized)
**************************************************/
...
/*************************************************
* Name:        poly_qiss_vec_256_l_set
*
* Description: Set a polynomial vector with PARAM_ARP_DIV_N_L_ISS entries equal to another polynomial vector
* 
* Arguments:   - poly_qiss_vec_256_l res: polynomial vector to be set (initialized)
* 			   		 - const poly_qiss_vec_256_l arg: polynomial vector to be read
**************************************************/
...
/*************************************************
* Name:        poly_qiss_vec_256_l_get_poly
*
* Description: Get pos-th entry polynomial of the vector
*              condition: [0 <= pos < PARAM_ARP_DIV_N_L_ISS]
* 
...
void poly_qiss_vec_256_l_get_poly(poly_qiss res, const poly_qiss_vec_256_l arg, size_t pos) {
  ASSERT_DEBUG(pos < PARAM_ARP_DIV_N_L_ISS, "Illegal argument: cannot get entry of vector at given position.");
	poly_qiss_set(res, arg->entries[pos]);
}

/*************************************************
* Name:        poly_qiss_vec_256_l_set_poly
*
* Description: Get pos-th entry polynomial of the vector
*              condition: [0 <= pos < PARAM_ARP_DIV_N_L_ISS]
* 
...
void poly_qiss_vec_256_l_set_poly(poly_qiss_vec_256_l res, const poly_qiss arg, size_t pos) {
  ASSERT_DEBUG(pos < PARAM_ARP_DIV_N_L_ISS, "Illegal argument: cannot set entry of vector at given position.");
	poly_qiss_set(res->entries[pos], arg);
}

/*************************************************
* Name:        poly_qiss_vec_256_l_neg
*
* Description: Negate a polynomial vector with PARAM_ARP_DIV_N_L_ISS entries
* 
* Arguments:   - poly_qiss_vec_256_l res: polynomial vector to host the negation (initialized)
* 			   		 - const poly_qiss_vec_256_l arg: polynomial vector to be negated
**************************************************/
...
/*************************************************
* Name:        poly_qiss_vec_256_l_add
*
* Description: Add two polynomial vectors with PARAM_ARP_DIV_N_L_ISS entries
* 
* Arguments:   - poly_qiss_vec_256_l res: polynomial vector to host the sum (initialized)
* 			   		 - const poly_qiss_vec_256_l lhs: first polynomial vector summand
* 			   		 - const poly_qiss_vec_256_l rhs: second polynomial vector summand
**************************************************/
...
/*************************************************
* Name:        poly_qiss_vec_256_l_sub
*
* Description: Substract two polynomial vectors with PARAM_ARP_DIV_N_L_ISS entries
* 
* Arguments:   - poly_qiss_vec_256_l res: polynomial vector to host the difference (initialized)
* 			   		 - const poly_qiss_vec_256_l lhs: first polynomial vector term
* 			   		 - const poly_qiss_vec_256_l rhs: second polynomial vector term
**************************************************/
...
/*************************************************
* Name:        poly_qiss_vec_256_l_mul_scalar
*
* Description: Multiplication of a polynomial vector with PARAM_ARP_DIV_N_L_ISS entries by a integer scalar
* 
* Arguments:   - poly_qiss_vec_256_l res: polynomial vector to host the multiplication (initialized)
* 			   		 - const poly_qiss_vec_256_l arg: polynomial vector factor
...
/*************************************************
* Name:        poly_qiss_vec_256_l_mul_poly_qiss
*
* Description: Multiplication of a polynomial vector with PARAM_ARP_DIV_N_L_ISS entries by a polynomial
* 
* Arguments:   - poly_qiss_vec_256_l res: polynomial vector to host the multiplication (initialized)
* 			   		 - const poly_qiss_vec_256_l lhs: first polynomial vector factor
...
void poly_qiss_vec_256_l_mul_poly_qiss(poly_qiss_vec_256_l out, const poly_qiss_vec_256_l lhs, const poly_qiss rhs) {
	for (size_t i = 0; i < PARAM_ARP_DIV_N_L_ISS; i++) {
		poly_qiss_mul(out->entries[i], lhs->entries[i], rhs);
	}
}

/*************************************************
* Name:        poly_qiss_vec_256_l_mul_inner
*
* Description: Inner product of two polynomial vectors with PARAM_ARP_DIV_N_L_ISS entries
* 
* Arguments:   - poly_qiss res: polynomial to host the inner product (initialized)
* 			   		 - const poly_qiss_vec_256_l lhs: first polynomial vector
* 			   		 - const poly_qiss_vec_256_l rhs: second polynomial vector
**************************************************/
...
/*************************************************
* Name:        poly_qiss_vec_256_l_norm2
*
* Description: Compute the square l2 norm of a polynomial vector
* 
* Arguments:   - const poly_qiss_vec_256_l arg: the polynomial vector
* 
...
/*************************************************
* Name:        poly_qiss_vec_256_l_equal
*
* Description: Equality test between two polynomial vectors with PARAM_ARP_DIV_N_L_ISS entries
* 
* Arguments:   - const poly_qiss_vec_256_l lhs: first polynomial vector
* 			   		 - const poly_qiss_vec_256_l rhs: second polynomial vector
* 
...
/*************************************************
* Name:        poly_qiss_vec_256_l_dump
*
* Description: Print a polynomial vector with PARAM_ARP_DIV_N_L_ISS entries
* 
* Arguments:   - const poly_qiss_vec_256_l arg: polynomial vector to be printed
**************************************************/
void poly_qiss_vec_256_l_dump(const poly_qiss_vec_256_l arg) {
	...
	poly_qiss_dump(arg->entries[PARAM_ARP_DIV_N_L_ISS - 1]);
	printf("]");
}

/*************************************************
* Name:        poly_qiss_vec_256_l_pack
*
* Description: Pack a polynomial vector mod PARAM_Q_ISS into a byte array
* 
* Arguments:   - uint8_t buf: output byte array (allocated POLYQISS_VEC256L_PACKEDBYTES bytes)
