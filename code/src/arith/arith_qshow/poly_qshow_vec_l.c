...
/*************************************************
* Name:        poly_qshow_vec_l_setup
*
* Description: Initialize and setup the backend for arithmetic 
*              mod PARAM_Q_SHOW integer vectors with PARAM_L_SHOW entries. 
...
/*************************************************
* Name:        poly_qshow_vec_l_teardown
*
...
/*************************************************
* Name:        poly_qshow_vec_l_init
*
* Description: Initialize polynomial vector with PARAM_L_SHOW entries.
*              This is strictly required before any operations 
*              are done with/on the vector.
* 
* Arguments:   - poly_qshow_vec_l arg: polynomial vector to be initialized
**************************************************/
void poly_qshow_vec_l_init(poly_qshow_vec_l arg) {
	for (size_t i = 0; i < PARAM_L_SHOW; ++i) {
		poly_qshow_init(arg->entries[i]);
	}
}

/*************************************************
* Name:        poly_qshow_vec_l_clear
*
* Description: Clear polynomial vector with PARAM_L_SHOW entries.
*              This is strictly required to avoid memory leaks and the 
*              polynomial vector must not be used again (unless reinitialized).
* 
* Arguments:   - poly_qshow_vec_l arg: polynomial vector to be cleared
**************************************************/
...
/*************************************************
* Name:        poly_qshow_vec_l_zero
*
* Description: Set an initialized polynomial vector with PARAM_L_SHOW entries to zero
* 
* Arguments:   - poly_qshow_vec_l arg: polynomial vector to be zeroized (initialized)
**************************************************/
...
/*************************************************
* Name:        poly_qshow_vec_l_set
*
* Description: Set a polynomial vector with PARAM_L_SHOW entries equal to another polynomial vector
* 
* Arguments:   - poly_qshow_vec_l res: polynomial vector to be set (initialized)
* 			   		 - const poly_qshow_vec_l arg: polynomial vector to be read
**************************************************/
...
/*************************************************
* Name:        poly_qshow_vec_l_get_poly
*
* Description: Get pos-th entry polynomial of the vector
*              condition: [0 <= pos < PARAM_L_SHOW]
* 
...
void poly_qshow_vec_l_get_poly(poly_qshow res, const poly_qshow_vec_l arg, size_t pos) {
	ASSERT_DEBUG(pos < PARAM_L_SHOW, "Illegal argument: cannot get entry of vector at given position.");
	poly_qshow_set(res, arg->entries[pos]);
}

/*************************************************
* Name:        poly_qshow_vec_l_set_poly
*
* Description: Get pos-th entry polynomial of the vector
*              condition: [0 <= pos < PARAM_L_SHOW]
* 
...
void poly_qshow_vec_l_set_poly(poly_qshow_vec_l res, const poly_qshow arg, size_t pos) {
	ASSERT_DEBUG(pos < PARAM_L_SHOW, "Illegal argument: cannot set entry of vector at given position.");
	poly_qshow_set(res->entries[pos], arg);
}

/*************************************************
* Name:        poly_qshow_vec_l_neg
*
* Description: Negate a polynomial vector with PARAM_L_SHOW entries
* 
* Arguments:   - poly_qshow_vec_l res: polynomial vector to host the negation (initialized)
* 			   		 - const poly_qshow_vec_l arg: polynomial vector to be negated
**************************************************/
...
/*************************************************
* Name:        poly_qshow_vec_l_add
*
* Description: Add two polynomial vectors with PARAM_L_SHOW entries
* 
* Arguments:   - poly_qshow_vec_l res: polynomial vector to host the sum (initialized)
* 			   		 - const poly_qshow_vec_l lhs: first polynomial vector summand
* 			   		 - const poly_qshow_vec_l rhs: second polynomial vector summand
**************************************************/
...
/*************************************************
* Name:        poly_qshow_vec_l_sub
*
* Description: Substract two polynomial vectors with PARAM_L_SHOW entries
* 
* Arguments:   - poly_qshow_vec_l res: polynomial vector to host the difference (initialized)
* 			   		 - const poly_qshow_vec_l lhs: first polynomial vector term
* 			   		 - const poly_qshow_vec_l rhs: second polynomial vector term
**************************************************/
...
/*************************************************
* Name:        poly_qshow_vec_l_mul_scalar
*
* Description: Multiplication of a polynomial vector with PARAM_L_SHOW entries by a integer scalar
* 
* Arguments:   - poly_qshow_vec_l res: polynomial vector to host the multiplication (initialized)
* 			   		 - const poly_qshow_vec_l arg: polynomial vector factor
...
/*************************************************
* Name:        poly_qshow_vec_l_mul_inner
*
* Description: Inner product of two polynomial vectors with PARAM_L_SHOW entries
* 
* Arguments:   - poly_qshow res: polynomial to host the inner product (initialized)
* 			   		 - const poly_qshow_vec_l lhs: first polynomial vector
* 			   		 - const poly_qshow_vec_l rhs: second polynomial vector
**************************************************/
...
/*************************************************
* Name:        poly_qshow_vec_l_norm2
*
* Description: Compute the square l2 norm of a polynomial vector
* 
* Arguments:   - const poly_qshow_vec_l arg: the polynomial vector
* 
...
/*************************************************
* Name:        poly_qshow_vec_l_equal
*
* Description: Equality test between two polynomial vectors with PARAM_L_SHOW entries
* 
* Arguments:   - const poly_qshow_vec_l lhs: first polynomial vector
* 			   		 - const poly_qshow_vec_l rhs: second polynomial vector
* 
...
/*************************************************
* Name:        poly_qshow_vec_l_dump
*
* Description: Print a polynomial vector with PARAM_L_SHOW entries
* 
* Arguments:   - const poly_qshow_vec_l arg: polynomial vector to be printed
**************************************************/
void poly_qshow_vec_l_dump(const poly_qshow_vec_l arg) {
	printf("[");
	for (size_t i = 0; i < PARAM_L_SHOW - 1; ++i) {
		poly_qshow_dump(arg->entries[i]);
		printf(", ");
	}
	poly_qshow_dump(arg->entries[PARAM_L_SHOW - 1]);
	printf("]");
}

/*************************************************
* Name:        poly_qshow_vec_l_pack
*
* Description: Pack a polynomial vector mod PARAM_Q_SHOW into a byte array
* 
* Arguments:   - uint8_t buf: output byte array (allocated POLYQSHOW_VECL_PACKEDBYTES bytes)
